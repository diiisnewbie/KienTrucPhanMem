...
// Chức năng: đăng ký content type mới, CRUD content
// Kết nối vào Core qua interface chuẩn — không biết gì về plugin khác
...
const ContentManagementPlugin = {
  ...
  activate() {
    ...
    // Đăng ký lắng nghe hook từ core
    ...
    // Expose API methods lên core để các plugin khác hoặc routes dùng
    this.api = {
      // Content Types
      ...
      async createContent(typeName, title, body, status = 'draft') {
        ...
        // Gọi core emit — hook before_save sẽ validate
